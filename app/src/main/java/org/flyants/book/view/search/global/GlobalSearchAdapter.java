...
class GlobalSearchAdapter extends BaseRecyclerAdapter<MessageUserSimpleInfo> {

    private ImageLoader imageLoader = new IconImageLoaderImpl();

    public GlobalSearchAdapter(RecyclerView recyclerView) {
    ...
    public GlobalSearchAdapter(RecyclerView v, Collection<MessageUserSimpleInfo> datas, int itemLayoutId) {
