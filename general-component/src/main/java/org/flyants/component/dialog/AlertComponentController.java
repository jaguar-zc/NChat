...
class AlertComponentController {

    private AlertComponentDialog mAlertDialog;
    private Window mWindow;
    private DialogComponentHelper mDialogViewHelper = null;

    AlertComponentController(AlertComponentDialog alertDialog, Window window) {
    ...
    static class AlertParams {
         ...
         * dialog构建方法
         */
        public void apply(AlertComponentController alertController) {

            if (mView != null) {
                alertController.mDialogViewHelper = new DialogComponentHelper(mView);
            }

            if (mViewLayoutResId != 0) {
                alertController.mDialogViewHelper = new DialogComponentHelper(mContext, mViewLayoutResId);
            }
